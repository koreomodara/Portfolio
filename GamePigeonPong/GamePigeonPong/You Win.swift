...
class YouWin: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        func setupMenu() {
            ...
            // Title Label
            let titleLabel = SKLabelNode(text: "YOU WON!")
            ...
            //add in crown sprite
            let crownImage = SKSpriteNode(imageNamed: "YouWin.PNG")
            crownImage.position = CGPoint(x: frame.midX, y: frame.midY)
            addChild(crownImage)
            ...
            // play again Button
            let newGameButtonLabel = SKLabelNode(text: "Play Again?")
